 ...
 */
module flow.engine.impl.bpmn.behavior.ScriptTaskActivityBehavior;
 ...
 * @author Falko Menge
 */
class ScriptTaskActivityBehavior : TaskActivityBehavior {
    ...
    this(string script, string language, string resultVariable) {
        this.script = script;
        this.language = language;
        this.resultVariable = resultVariable;
    }

    this(string scriptTaskId, string script, string language, string resultVariable, bool storeScriptVariables) {
