 ...
 */
module flow.variable.service.impl.types.LongType;
...
class LongType : VariableType {
    ...
    public void setValue(Object value, ValueFields valueFields) {
        ...
        valueFields.setLongValue(v);
        if (value !is null) {
            valueFields.setTextValue(v.toString);
        } else {
    ...
    public bool isAbleToStore(Object value) {
        ...
        return cast(Long)value !is null ? true: false;
