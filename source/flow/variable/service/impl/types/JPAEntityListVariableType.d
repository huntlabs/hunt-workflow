...
//                    canStore = entity !is null && mappings.isJPAEntity(entity) && mappings.getEntityMetaData(entity.getClass()).getEntityClass().equals(entityClass);
//                    if (!canStore) {
...
//        if (entityManagerSession is null) {
...
//        if (valueFields.getTextValue() !is null && bytes !is null) {
