 ...
 */
module flow.common.db.DbSqlSessionFactory;
...
// * @author Joram Barrez
// */
//class DbSqlSessionFactory implements SessionFactory {
//
...
//        if (getDatabaseSchema() !is null && getDatabaseSchema().length() > 0) {
//            try {
...
//            }
//        }
//        if (getDatabaseCatalog() !is null && getDatabaseCatalog().length() > 0) {
//            try {
...
//            }
//        }
//        if (dbSqlSession.getSqlSession().getConnection() is null) {
...
//        if (statementMappings is null) {
//            return statement;
//        }
//        String mappedStatement = statementMappings.get(statement);
//        return (mappedStatement !is null ? mappedStatement : statement);
//    }
//
...
//        return bulkInserteableEntityClasses !is null && bulkInserteableEntityClasses.contains(entityClass);
//    }
//
