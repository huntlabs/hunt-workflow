...
module flow.common.FlowableVersions;
...
class FlowableVersions {
    ...
    public static  string CURRENT_VERSION = "6.5.0.6"; // Note the extra .x at the end. To cater for snapshot releases with different database changes

    public static  List!FlowableVersion FLOWABLE_VERSIONS  ;//= new ArrayList<>();

    public static  string LAST_V5_VERSION = "5.99.0.0";

    public static  string LAST_V6_VERSION_BEFORE_SERVICES = "6.1.2.0";

    shared static this () {
        if (FLOWABLE_VERSIONS is null)
        {
            FLOWABLE_VERSIONS = new ArrayList!FlowableVersion;
        }
        /* Previous */
