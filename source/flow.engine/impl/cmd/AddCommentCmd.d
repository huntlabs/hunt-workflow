 ...
 */
module flow.engine.impl.cmd.AddCommentCmd;
 ...
 * @author Tom Baeyens
 */
class AddCommentCmd : Command!Comment {
    ...
    this(string taskId, string processInstanceId, string message) {
        this.taskId = taskId;
        this.processInstanceId = processInstanceId;
        this.message = message;
    }

    this(string taskId, string processInstanceId, string type, string message) {
        this.taskId = taskId;
        this.processInstanceId = processInstanceId;
        this.type = type;
        this.message = message;
    ...
    public Comment execute(CommandContext commandContext) {
        ...
        //        throw new FlowableObjectNotFoundException("execution " ~ processInstanceId ~ " doesn't exist", typeid(Execution));
        //    }
        //
