 ...
 */
module flow.engine.impl.cmd.NeedsActiveExecutionCmd;
 ...
 * @author Joram Barrez
 */
abstract class NeedsActiveExecutionCmd(T) : Command!T {
    ...
    public T execute(CommandContext commandContext) {
        ...
        if (execution is null) {
            throw new FlowableObjectNotFoundException("execution " ~ executionId ~ " doesn't exist", typeid(Execution));
        }
