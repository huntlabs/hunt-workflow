...
class JPAEntityScanner {
    ...
    public EntityMetaData scanClass(Class<?> clazz) {
        ...
        while (clazz !is null && !clazz.equals(Object.class)) {
    ...
    private Method getIdMethod(Class<?> clazz) {
        ...
        for (Method method : methods) {
            ...
            if (idAnnotation !is null && !method.isBridge()) {
                idMethod = method;
                break;
            }
        }
    ...
    private Field getIdField(Class<?> clazz) {
        ...
        if (idField is null) {
            ...
            if (superClass !is null && !superClass.equals(Object.class)) {
    ...
    private boolean isEntityAnnotationPresent(Class<?> clazz) {
        return (clazz.getAnnotation(Entity.class) !is null);
    }
}
