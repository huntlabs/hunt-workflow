...
class EntityManagerSessionImpl implements EntityManagerSession {
    ...
    @Override
    public void flush() {
        if (entityManager !is null && (!handleTransactions || isTransactionActive())) {
            try {
                entityManager.flush();
    ...
    protected boolean isTransactionActive() {
        if (handleTransactions && entityManager.getTransaction() !is null) {
    ...
    @Override
    public void close() {
        if (closeEntityManager && entityManager !is null && entityManager.isOpen()) {
            try {
                entityManager.close();
            } catch (IllegalStateException ise) {
