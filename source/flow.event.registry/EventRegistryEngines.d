...
module flow.event.registry.EventRegistryEngines;
...
//        if (!isInitialized()) {
//            if (eventRegistryEngines is null) {
...
//        try {
//            Class<?> springConfigurationHelperClass = ReflectUtil.loadClass("flow.event.registry.spring.SpringEventRegistryConfigurationHelper");
...
//                } catch (Exception e) {
//                    LOGGER.error("exception while closing {}", (eventRegistryEngineName is null ? "the default event registry engine" :
